...
public class CreateQuestionGUI extends JFrame {
	...
	public CreateQuestionGUI(Vector<domain.Event> v) {
		try {
			setTitle(ResourceBundle.getBundle("Etiquetas").getString("CreateQuestionGUI"));
			jbInit(v);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	private void jbInit(Vector<domain.Event> v) throws Exception {
		...
		final JLabel lblEbentuaBukatuDa = new JLabel(ResourceBundle.getBundle("Etiquetas").getString("CreateQuestionGUI.lblEbentuaBukatuDa.text")); //$NON-NLS-1$ //$NON-NLS-2$
		lblEbentuaBukatuDa.setForeground(Color.RED);
		lblEbentuaBukatuDa.setFont(new Font("Tahoma", Font.PLAIN, 13));
		lblEbentuaBukatuDa.setBounds(275, 127, 130, 30);
